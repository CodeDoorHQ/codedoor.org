	...
	SEMICOLON.header = {
		...
		topsearch: function(){
			...
			$(document).on('click', function(event) {
				...
				if (!$(event.target).closest('#top-lang').length) { $topCart.toggleClass('top-lang-open', false); }
			...
			$("#top-search-trigger").click(function(e){
				...
				$topCart.toggleClass('top-lang-open', false);
		...
		topcart: function(){
			...
			$("#top-lang-trigger").click(function(e){
				$pagemenu.toggleClass('pagemenu-active', false);
				$topCart.toggleClass('top-lang-open');
				e.stopPropagation();
				e.preventDefault();
			});
